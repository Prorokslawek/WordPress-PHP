<?php
/*
Plugin Name: imieniny
Description:Wtyczka z imieninami!
Version: 2.3.3
...
function imieniny(){
    $imieniny_data = array(
        ...
        $dzien=date('l');
        echo ($dzien);
        echo ('Jest godzina: '.$czas.' ');
        $data=date('m-d');
        //$kolejny_dzien=date('m-d', strtotime("+1 day"));
        //Wyświetlenie daty
        $date=date('d-m-Y').' są imieniny: ';
        echo $date;
        ?>
        <h1 style=font-size:bigger;><?php echo ($imieniny_data[$data]);?></h1>
        <?php
        //Statycznie wyswietlone kolejne dni z imieninami
        echo'<b>Imieniny w kolejnych dniach: </b>';
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+1 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+2 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+3 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+4 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+5 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+6 day"))]);
        echo '<br>';
        echo($imieniny_data[date('m-d', strtotime("+7 day"))]);
        echo '<br>';

    }
    add_shortcode('uro','imieniny');
    //add_filter( 'auto_update_plugin' , '__return_true' ); //włączenie auto-aktualizacji
 
    require 'plugin-update-checker/plugin-update-checker.php';
    $myUpdateChecker = PucFactory::buildUpdateChecker(

	'http://slawekstefanski.wysylaj.pl/aktualizacja_wtyczki/plugin.json',
	__FILE__
);